...
export default ({rotate}) => (
  <svg className='RotateArrows' // is a class of all
      ...
      <g opacity = ".25" onClick={() => rotate('x', true)} >
      ...
      <g opacity = ".25" onClick={() => rotate('z', true)}>
      ...
      <g opacity = ".25" onClick={() => rotate('z', false)}>
      ...
      <g opacity = ".25" onClick={() => rotate('y', false)}>
      ...
      <g opacity = ".25" onClick={() => rotate('y', true)}>
